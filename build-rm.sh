...
source $RM_TOOLCHAIN/environment-setup-cortexa9hf-neon-oe-linux-gnueabi

set -euo pipefail

# This is needed to cross-build with bindgen
export BINDGEN_EXTRA_CLANG_ARGS="\
  -I$RM_TOOLCHAIN/sysroots/cortexa9hf-neon-oe-linux-gnueabi/usr/include/c++/7.3.0\
  -I$RM_TOOLCHAIN/sysroots/cortexa9hf-neon-oe-linux-gnueabi/usr/include\
  -I$RM_TOOLCHAIN/sysroots/cortexa9hf-neon-oe-linux-gnueabi/usr/include/c++/7.3.0/arm-oe-linux-gnueabi"
